...
class SmartPageCommand extends Command
{
    public $signature = 'make:smartpage {name} {panel?}';

    public $description = 'Create a new smartpage';
    ...
    public function handle(): void
    {
        ...
        $this->createViewFromStub('filament.smartpages.'.str($this->argument('name'))->lower()->slug());
    ...
    public function getSourceFilePath(): string
    {
        ...
        $path = base_path('app\\Filament\\'.$panelPrefix.'Pages').'\\'.$this->getSingularClassName($this->argument('name')).'SmartPage.php';
