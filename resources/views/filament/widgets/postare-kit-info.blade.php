<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    href="https://github.com/inerba/postare-kit-12"
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ \Composer\InstalledVersions::getPrettyVersion('inerba/postare-kit-12') }}
                </p>
            </div>
            ...
            <div class="flex flex-col items-end gap-y-1">
                ...
                <x-filament::link
                    color="gray"
                    href="https://github.com/inerba/postare-kit-12#postare-kit-12"
