...
<div
    class="not-prose relative w-full shadow-xl"
    x-data="{
        splide: null,
        currentSlide: 0,
        videos: [],
                    ...
                    <li class="splide__slide relative" data-index="{{ $loop->index }}">
                        @if ($slide["is_video"])
                            <video
                                ...
                                playsinline
                                loading="lazy"
                                class="{{ $sliderHeight }} w-full object-cover object-center"
                        ...
                        @else
                            <img
                                ...
                                alt="{{ $slide["alt"] ?? "Immagine slide " . ($loop->index + 1) }}"
                                loading="lazy"
                        ...
                        @if ($slide["title"] || $slide["content"])
                            <div x-data="{ show: true }">
                                <div
                                    ...
                                    class="bg-logo1/35 absolute inset-0"
                                ></div>
                                <div
                                    x-show="show"
                                ...
                                >
                                    ...
                                    <template x-teleport="#commands">
                                        <button
                                            x-show="! show && currentSlide === {{ $loop->index }}"
                                            @click="show=true"
                                            type="button"
