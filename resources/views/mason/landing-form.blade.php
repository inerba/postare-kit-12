...
<x-mason.section :theme="$theme">
    <div class="mx-4 xl:mx-0">
            ...
            <div class="flex flex-col gap-4 bg-white p-6 lg:flex-row">
                <form class="w-full">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="h-32 w-full border border-gray-400 p-2" id="message"></textarea>
                    </div>
                    <div class="mb-4">
                        <div class="flex items-center">
                            ...
                            <label class="ml-2 text-sm text-gray-700" for="gdprConsent">
                                Acconsento al trattamento dei miei dati come descritto nella
                                <a
                                    class="border-b text-indigo-700"
                                    href="{{ route('portal.page', ['slug' => 'consenso-al-trattamento-dei-dati']) }}"
                                    target="_blank"
                                >
        ...
        @else
            <x-dealers.form :$dealer :showMap="false" />
        @endif
        @if ($buttons)
